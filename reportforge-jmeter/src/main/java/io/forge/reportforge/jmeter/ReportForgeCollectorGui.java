...
/**
 * GUI for the ReportForge Collector listener (FR-604).
 * Appears in JMeter's Add → Listener menu as "ReportForge Collector".
 *
 ...
 * </ul>
 */
public class ReportForgeCollectorGui extends AbstractListenerGui {
    ...
    public ReportForgeCollectorGui() {
        super();
        init();
    }
    ...
    public TestElement createTestElement() {
        ReportForgeCollector collector = new ReportForgeCollector();
    ...
    public void modifyTestElement(TestElement element) {
        ...
        if (element instanceof ReportForgeCollector collector) {
