...
/**
 * Registers "TurviForge: Generate Advanced Report" under JMeter's Tools menu (FR-601).
 ...
 */
public class TurviForgeMenuCreator implements MenuCreator {
    ...
    public JMenuItem[] getMenuItemsAtLocation(MENU_LOCATION location) {
        ...
        JMenuItem item = new JMenuItem("TurviForge: Generate Advanced Report", KeyEvent.VK_R);
        item.setName("turviforge_generate");
        item.addActionListener(e -> TurviForgeDialog.open());
